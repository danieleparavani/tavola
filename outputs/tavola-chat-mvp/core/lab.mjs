...
const ideasSchema={type:'object',additionalProperties:false,required:['ideas'],properties:{ideas:{type:'array',minItems:3,maxItems:3,items:{type:'object',additionalProperties:false,required:['level','name','description','principle','focus'],properties:{level:{type:'string',enum:['simple','technical','gourmet']},name:{type:'string'},description:{type:'string'},principle:{type:'string'},focus:{type:'string'}}}}}};
