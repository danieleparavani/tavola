...
Ultimo aggiornamento: 28 agosto 2026 (D-039: corretto un terzo bug segnalato dal progettista poche ore dopo D-038 — chiedeva di iniziare una nuova richiesta e il bot restava "in loop" sulla ricetta di seppia in corso; ampliato isIntentChoice con frasi generiche di riavvio e aggiunto lo stesso ramo di uscita a cooking, lab_clarification e difficulty_choice, 69/69 test, verificato dal vivo con una vera chiamata al laboratorio fino allo stato cooking, deployato sulla VM. D-036, D-037 e D-038 confermati deployati sulla VM in una sessione precedente. Restano da verificare dal vivo su Telegram reale: D-034 (consenso, orario D+1, consegna proattiva), D-036 (techniqueMapId), D-037 (fix "Altra idea"), D-038 e D-039 (cambio di percorso da qualunque stato).)
